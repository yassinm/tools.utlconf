...
UTLAPPS_vulkan_env(){
    VULKAN_VER="1.0.17.0"
    VULKAN_ROOT="${UTL3RDP_APPS}/vulkan"

    VULKAN_GLFW="${VULKAN_ROOT}/glfw-3.2"
    VULKAN_SDK="${VULKAN_ROOT}/VulkanSDK"
    VULKAN_DIR="${VULKAN_SDK}/${VULKAN_VER}"

    #export PATH=${VULKAN_DIR}:${PATH}
    export VK_LAYER_PATH="${VULKAN_DIR}/x86_64/etc/explicit_layer.d"
    export LD_LIBRARY_PATH="${VULKAN_DIR}/x86_64/lib:${LD_LIBRARY_PATH}"
