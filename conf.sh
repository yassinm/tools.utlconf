...
utl_init_env(){
  ...
  UTLROOT="${HOME}/work/_utl"
  UTLLOCAL="${UTLROOT}/utl-local"
  UTLNOTES="${UTLROOT}/utl-notes"

  export UTLCONF="${UTLROOT}/utl-conf"

  UTLCONF_BASHRC="${HOME}/.bashrc"
  UTLCONF_FOLDERS="${UTLCONF} ${UTLLOCAL} ${UTLNOTES}"
